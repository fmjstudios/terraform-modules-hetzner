...
variable "networking" {
  type        = any
  description = "The networking settings to apply to the instace. Like whether IPv6 is enabled or not. By default both IPv4 and IPv6 are enabled. The IPv4 address may be manually or automatically assigned via Hetzner."
  default     = {}
}
...
variable "placement_group_id" {
  type        = string
  description = "The ID of a placment group to attach to the server."
  default     = null
}
